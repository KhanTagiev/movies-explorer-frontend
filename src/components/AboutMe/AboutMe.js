        ...
        <div className="about-me__profile-container">
          <div>
            ...
            <p className="about-me__profile-info">
              ...
              РАНХиГС. Я люблю смотреть фильмы и сериалы по Вселенной Marvel и
              DC, а ещё увлекаюсь плаванием. Недавно начал кодить. С 2012 года
              работал в компании «Бургер Кинг». После того, как прошёл курс по
